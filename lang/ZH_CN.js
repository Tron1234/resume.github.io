export const selfAssessment_title = "自我定位"
...
export const selfAssessment = `从事这个行业已经有4年的时间了，在4年中做过独立开发多端项目、大部分服务端项目，有了一定的技术沉淀，也发现自身的一些技术问题，从会用到“下潜”深究原理。可能很多人认为前端开发没有技术难度，因为业务代码基本在后端，但对我一个从科班学后端最后走向前端的人来说，前端的魅力在于可以及时看到华丽的样式和动画效果，相比于无聊的大量数据，这才是我期待的`
export const sendGift = `请向下划动打开礼物`
export const peroration = `感谢您的阅览,祝您幸福！`
...
export const chapters = [{
  ...
  summarize_title: '自我总结',
  summarize: `作为一名前端工程师，不仅仅技术上要精益求精，更要有创造新思维和一定的审美能力，才能制作出让用户耳目一新的产品。本人性格开朗，喜欢与人交流广交朋友，能快速融入新的人际圈，增强团队合作能力。拥有较强的学习能力和人际交往能力，对时间有严格的把握，并且追求高效的团队开发效率。另外，对新技术有浓厚的兴趣和求知欲，对各种电子产品有所了解，喜欢自己动手维修；日常生活喜欢看文学小说、听歌、吉他、户外等`
}, {
  title: '工作经历',
  list: [{
    time: '2021.09 - 2023.03',
    company: '深圳东方大唐信息技术有限公司',
    jobName: 'Web前端工程师',
    jobContent: ['1.	编写EHR管理系统级联组件并内嵌至编写的列表筛选组件、table表格动态筛选列组件，并对系统进行维护和新需求迭代', '维护和迭代智慧工地web端、App端、微信小程序端项目','独立开发物联网IOT平台','制作POC智慧巡防系统','开发海职英语口译AI评测系统']
  }, {
    ...
    company: '九江市佳码技术有限公司',
    jobName: '小程序开发工程师',
    jobContent: ['绘制“汇校宝”微信小程序原型图和UI图，', '独立开发物联网IOT平台', '根据前端规范架构和UI设计稿实现前端项目整体架构和组件库', '制作POC智慧巡防系统', '开发海军职业英语口译AI评测系统']
  }]
}, {
  skillsIntro: '技能介绍',
  commonSkills: '常用技术',
  ...
  name: '九江学院',
  introduction: '九江学院是经国家教育部批准设立的国有公办全日制本科普通高等院校,坐落在长江中下游历史文化名城——江西省九江市，地处赣、鄂、湘、皖四省交界区域，位于庐山之麓、长江之滨、鄱阳湖之畔。名城、名山、名江、名湖造就了九江学院的独特优势，尤其是具有千年历史、享有“天下书院之首”美誉的白鹿洞书院，更为九江学院赋予了深厚的文化底蕴',
  college: '信息科学与技术学院',
  major: '计算机科学与技术专业',
  list: ['2019年获得院系三等奖学金', '取得国家二级计算机（Java）证书、软件技术初级程序员证书、计算机职业资格中级', '2016、2017年荣获国家励志奖学金'],
